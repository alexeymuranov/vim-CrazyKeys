...
nnoremap <SID>key_% :%s///Igc<Left><Left><Left><Left><Left>
vnoremap <SID>key_% :s///Igc<Left><Left><Left><Left><Left>
nnoremap <SID>2keyseq_'% :%s/<C-r>///Igc<Left><Left><Left><Left>
vnoremap <SID>2keyseq_'% :s/<C-r>///Igc<Left><Left><Left><Left>
